...
namespace PTRex.Controllers
{
    public class TargetWorkoutsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ExerciseID,UserProfileID,TargetNumSets,TargetNumReps,TargetSessionsPerDay,TargetNotes,ExerciseNickName")] TargetWorkout targetWorkout)
        {
            if (ModelState.IsValid)
            {
